window.onload = function(){
    tinymce.init({
        ...
        plugins: ['a11ychecker advcode advlist lists link  autolink lists checklist autosave code','preview','searchreplace','wordcount','media table emoticons image imagetools'],
        ...
        images_upload_handler: function(blobInfo,success,failure){
            ...
            fetch(req)
                ...
                .catch(()=>failure('HTTP ERROR OCCURED'))
        }
    })
}